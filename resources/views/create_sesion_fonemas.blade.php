...
@php($nav = 'Pacientes')
@section('title','Asignar Sesión de Fonema')
...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <form action="{{ route('crear_sesion_fonemas',$id_medico) }}" method="post" enctype="multipart/form-data"
                  class="card">
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-label">Fonemas</div>
                            <div>
